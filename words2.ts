...
export const words: Question[] = [
  ...
  },
  {
    ...
    spanish:
      "además, sin embargo, por lo tanto, mientras que, aunque, en cambio.",
  },
  {
    norwegian: "næmmen",
    english: "well",
  ...
  {
    norwegian: "å forlate editoren",
    english: "to leave the editor",
    spanish: "dejar el editor",
  },
  {
    norwegian: "hurtigtaster",
    english: "keyboard shortcuts",
    spanish: "atajos de teclado",
  },
  {
    norwegian: "ypperlig",
    english: "excellent",
  ...
  {
    norwegian: "den nåværende jobben",
    english: "the current job",
    spanish: "el trabajo actual",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "¿Deberían los maestros ser reemplazados por herramientas digitales?",
  },
  {
    norwegian: "vi bryte",
    english: "we break",
  ...
  },
  {
    ...
    english:
      "grammar, pronunciation, vocabulary or understanding different dialects",
    spanish:
      "gramática, pronunciación, vocabulario o comprensión de diferentes dialectos",
  },
  {
  ...
  {
    norwegian:
      "Jeg fikset og jeg fullførte og jeg bygget og jeg skapte og jeg opprettet og jeg laget",
    english:
      "I fixed and i completed and I built and I created and I established and I made",
    spanish: "Yo arreglé y terminé y construí y creé y establecí y hice",
  },
  {
    norwegian:
      "Jeg satte og jeg fullførte og jeg utviklet og jeg satte opp og jeg la til og jeg klarte og jeg gjorde",
    english:
      "I put and I finished and I developed and I set up and I added and I managed to and I did",
    spanish:
      "Yo puse y terminé y desarrollé y configuré y añadí y logré y hice",
  },
  {
    norwegian: "Beskriv ditt drømmereisemål. Hvorfor vil du dit?",
    english:
      "Describe your dream travel destination. Why do you want to go there?",
  ...
  {
    norwegian:
      "Hvis du kunne være dyktig i noe du ikke er i dag, hva ville det vært?",
    english:
      "If you could be skilled at something you are not today, what would it be?",
  ...
  },
  {
    ...
    spanish:
      "¿Cómo han cambiado las aerolíneas de bajo costo la forma en que viajamos?",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "la atención médica preventiva es más importante que el tratamiento",
  },
  {
    norwegian:
      "Hva gjør du personlig for å holde deg både fysisk og mentalt i form?",
    english:
      "What do you personally do to stay both physically and mentally fit?",
    spanish:
      "¿Qué haces personalmente para mantenerte en forma tanto física como mentalmente?",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "la responsabilidad de la sociedad de garantizar que las personas vivan de manera saludable",
  },
  {
    norwegian: "matvarer",
  ...
  },
  {
    ...
    spanish:
      "¿Puede la tecnología reemplazar completamente el contacto humano?",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "¿Cómo podemos promover un estilo de vida más saludable en la población?",
  },
  {
    norwegian: "Hvordan påvirker kostholdet vårt helse og velvære på sikt?",
    english:
      "How does our diet affect our health and well-being in the long term?",
    spanish:
      "¿Cómo afecta nuestra dieta a nuestra salud y bienestar a largo plazo?",
  },
  {
  ...
  },
  {
    ...
    spanish:
      '¿Cuál es el significado de "actividades al aire libre" para los noruegos?',
  },
  {
  ...
  {
    norwegian:
      "Hvordan kan man fremme bedre forståelse mellom ulike kulturer i Norge?",
    english:
      "How can we promote better understanding between different cultures in Norway?",
    spanish:
      "¿Cómo podemos promover una mejor comprensión entre diferentes culturas en Noruega?",
  },
  {
  ...
  {
    norwegian:
      "Er ytringsfrihet absolutt, eller bør den begrenses i noen tilfeller? Gi eksempler.",
    english:
      "Is freedom of speech absolute, or should it be limited in some cases? Give examples.",
    spanish:
      "¿Es la libertad de expresión absoluta o debería limitarse en algunos casos? Da ejemplos.",
  },
  {
  ...
  {
    norwegian:
      "Hvordan kan vanlige borgere bidra til et mer bærekraftig samfunn?",
    english:
      "How can ordinary citizens contribute to a more sustainable society?",
    spanish:
      "¿Cómo pueden los ciudadanos comunes contribuir a una sociedad más sostenible?",
  },
  {
  ...
  {
    norwegian: "basehopping",
    english: "base jumping",
    spanish: "salto base",
  },
  {
    norwegian: "en sjøreise",
    english: "a sea voyage",
    spanish: "un viaje en el mar",
  },
  {
    norwegian: "sjøsyke",
    english: "seasickness",
  ...
  },
  {
    norwegian: "en skitur",
    english: "a ski trip",
    spanish: "un viaje de esquí",
  },
  {
    norwegian: "høyder sikkerhet",
    english: "height safety",
    spanish: "seguridad en altura",
  },
  {
    norwegian: "vintersolverv",
    english: "winter solstice",
  ...
  {
    norwegian:
      "Nå kan DU gi beskjed om hva du mener om absolutt aldersgrense i sosiale medier",
    english:
      "Now YOU can let us know what you think about the absolute age limit on social media",
    spanish:
      "Ahora PUEDES hacernos saber qué piensas sobre el límite de edad absoluto en las redes sociales",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "10.000 offentlige ansatte går fra Microsoft og Office til open source og OnlyOffice.",
    english:
      "10,000 public employees are leaving Microsoft and Office for open source and OnlyOffice.",
    spanish:
      "10,000 empleados públicos están dejando Microsoft y Office por open source y OnlyOffice.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "(Stillingsannonse) Vil du bli medeier* i Boitano? Sjekk ut denne spennende muligheten!",
    english:
      "(Job advertisement) Do you want to become a co-owner* of Boitano? Check out this exciting opportunity!",
    spanish:
      "(Anuncio de trabajo) ¿Quieres convertirte en copropietario* de Boitano? ¡Consulta esta emocionante oportunidad!",
  },
  {
    norwegian:
      "Både Meta og Anthropic har denne uka vunnet fram med å trene AI-en sin på kopibeskytta bøker.",
    english:
      "Both Meta and Anthropic have won this week with training their AI on copyrighted books.",
    spanish:
      "Tanto Meta como Anthropic han ganado esta semana al entrenar su IA con libros protegidos por derechos de autor.",
  },
  {
    norwegian:
      "Hvis vi blir så mye mer effektive av AI, kan vi ikke da få en ekstra fridag i uka?",
    english:
      "If we become so much more efficient with AI, can’t we then get an extra day off a week?",
    spanish:
  ...
  {
    norwegian:
      "Blåskjermen i Windows forsvinner! Men ikke fordi Windows aldri skal kræsje lenger, såklart.",
    english:
      "The blue screen in Windows is disappearing! But not because Windows will never crash again, of course.",
    spanish:
  ...
  },
  {
    ...
    english:
      "The valve was opened to 100 percent, they tell about the hacking.",
  ...
  },
  {
    ...
    english:
      "It is still just as demanding and confusing to manage having a seriously ill child or losing a spouse.",
    spanish:
  ...
  },
  {
    ...
    english:
      "Norwegian businesses must understand that AI is not just a tool, it is also a weapon for criminals.",
    spanish:
  ...
  {
    norwegian:
      "En tester er langt mer enn en som finner bugs, skriver Testleder Gerd Stalheim Wiggen i Miles.",
    english:
      "A tester is much more than someone who finds bugs, writes Test Leader Gerd Stalheim Wiggen at Miles.",
    spanish:
      "Un tester es mucho más que alguien que encuentra errores, escribe la Líder de Pruebas Gerd Stalheim Wiggen en Miles.",
  },
  {
    norwegian:
      "Det er ikke bare å sette opp en nettside, det er en hel prosess som må til for å lykkes.",
    english:
      "It is not just about setting up a website, it is a whole process that must be done to succeed.",
    spanish:
      "No se trata solo de configurar un sitio web, es todo un proceso que debe realizarse para tener éxito.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Bare minutter unna turistfellene finnes bedre alternativer. Her er en oversikt.",
    english:
      "Just minutes away from the tourist traps, there are better alternatives. Here is an overview.",
    spanish:
      "A solo minutos de las trampas turísticas, hay mejores alternativas. Aquí tienes un resumen.",
  },
  {
    norwegian: "Planer om sopptur til høsten? Nå kommer FHI med en advarsel.",
    english:
      "Planning a mushroom trip this fall? Now FHI comes with a warning.",
    spanish:
      "¿Planeando un viaje de setas este otoño? Ahora FHI emite una advertencia.",
  },
  {
    norwegian:
      "Forrige sesong var et møkkete kaos. Nå er serien tilbake i stjerneform. Les anmeldelsen her.",
    english:
      "Last season was a dirty chaos. Now the series is back in star form. Read the review here.",
    spanish:
  ...
  {
    norwegian:
      "Når voksne barn forventer foreldresponsing på fellesferien: Slik tar du praten. ",
    english:
  ...
  {
    norwegian:
      "Du trenger ikke nødvendigvis flytte til Spydeberg for å slippe de høye boligprisene i Oslo.",
    english:
      "You don’t necessarily have to move to Spydeberg to escape the high housing prices in Oslo.",
    spanish:
  ...
  {
    norwegian:
      "Da Martin Ødegaard fyrte løs i sosiale medier, ble Ada Hegerberg skuffet og opprørt.",
    english:
      "When Martin Ødegaard fired off on social media, Ada Hegerberg was disappointed and upset.",
    spanish:
      "Cuando Martin Ødegaard disparó en las redes sociales, Ada Hegerberg se sintió decepcionada y molesta.",
  },
  {
    norwegian:
      "En ti år gammel bok om voksne barn og deres umodne foreldre vekker oppsikt. Her er forfatterens råd.",
    english:
  ...
  },
  {
    ...
    english:
      "I know what it means to grow up in a culture where religion is truth and control, writes Hilde Sandvik.",
    spanish:
      "Sé lo que significa crecer en una cultura donde la religión es verdad y control, escribe Hilde Sandvik.",
  },
  {
    norwegian:
      "Nå er det klart for den store finalen i «Farmen kjendis». Her er alt du trenger å vite.",
    english:
      'Now it is time for the grand finale of "Farmen kjendis". Here is everything you need to know.',
    spanish:
      'Ahora es el momento de la gran final de "Farmen kjendis". Aquí tienes todo lo que necesitas saber.',
  },
  {
  ...
  {
    norwegian:
      "Stortingspolitikeren mener rasisme ikke er et stort problem i Norge.",
    english:
      "The Member of Parliament believes that racism is not a big problem in Norway.",
    spanish:
      "El político del Parlamento cree que el racismo no es un gran problema en Noruega.",
  },
  {
    norwegian: "Skal du se «Jurassic World Rebirth»? Her er anmeldelsen.",
    english:
      'Are you going to see "Jurassic World Rebirth"? Here is the review.',
    spanish: '¿Vas a ver "Jurassic World Rebirth"? Aquí está la reseña.',
  },
  {
    norwegian:
      "Oasis-brødrene sammen på scenen igjen for første gang på 15 år. Hva er din favorittlåt?",
    english:
      "Oasis brothers together on stage again for the first time in 15 years. What is your favorite song?",
    spanish:
      "Hermanos de Oasis juntos en el escenario nuevamente por primera vez en 15 años. ¿Cuál es tu canción favorita?",
  },
  {
    norwegian:
      "På 10 minutter spiste han 70,5 wienerpølser med brød. Hvor mange hadde du klart?",
    english:
      "In 10 minutes, he ate 70.5 hot dogs with bread. How many could you manage?",
    spanish:
      "En 10 minutos, se comió 70,5 salchichas con pan. ¿Cuántas podrías comer tú?",
  },
  {
    norwegian:
      "Ta kontakt med kjærestens ekser? – Jeg er ganske sikker på at det ikke er en god idé, svarer Frode Thuen.",
    english:
      "Contact your partner’s exes? - I’m pretty sure that’s not a good idea, answers Frode Thuen.",
    spanish:
      "¿Contactar con los ex de tu pareja? - Estoy bastante seguro de que no es una buena idea, responde Frode Thuen.",
  },
  {
    norwegian:
      "Kulturministeren har bestemt seg: Dropper rådyr løsning for Nationaltheatret.",
    english:
      "The Minister of Culture has made up her mind: Drops expensive solution for the National Theatre.",
    spanish:
      "La ministra de Cultura ha tomado una decisión: Descarta una solución costosa para el Teatro Nacional.",
  },
  {
    norwegian:
      "Ladetabbene du bør unngå å gjøre i sommer. Tips i kommentarfeltet.",
    english:
      "Charging mistakes you should avoid making this summer. Tips in the comment section.",
    spanish:
      "Errores de carga que debes evitar este verano. Consejos en la sección de comentarios.",
  },
  {
    norwegian:
      "Nå er det klart for den store finalen i «Farmen kjendis». Her er alt du trenger å vite.",
  ...
  },
  {
    ...
    english:
      "Residents in a municipal block had to manage without an elevator.",
    spanish:
      "Los residentes de un bloque municipal tuvieron que arreglárselas sin ascensor.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Nyttig oversikt enten man skal være i - eller besøke - Oslo i sommer.",
    english:
      "Useful overview whether you are going to be in - or visit - Oslo this summer.",
    spanish:
      "Resumen útil ya sea que vayas a estar en - o visitar - Oslo este verano.",
  },
  {
  ...
  {
    norwegian:
      "Mens kundene venter på rentekuttet, får 11.000 DNB-ansatte langt bedre vilkår.",
    english:
      "While customers wait for the interest rate cut, 11,000 DNB employees get much better terms.",
    spanish:
  ...
  },
  {
    ...
    english:
      "Is princess treatment romantic or old-fashioned? Etiquette expert believes it is time to scrap the term.",
    spanish:
  ...
  {
    norwegian:
      "Veldig dyrt, sier turistene om P-prisen. De må betale tusenvis for to dager.Lenke i kommentarfeltet.",
    english:
  ...
  {
    norwegian:
      "Noe av det større vi kan få i Norge, sier meteorolog. (Lenke i kommentarfeltet)",
    english:
      "Something of the larger we can get in Norway, says the meteorologist. (Link in the comment section)",
    spanish:
      "Algo de lo más grande que podemos tener en Noruega, dice el meteorólogo. (Enlace en la sección de comentarios)",
  },
  {
    norwegian:
      "Bare elleve dager tidligere fikk han «ja, til evig tid» fra sitt livs kjærlighet.",
    english:
      'Just eleven days earlier, he got "yes, for eternity" from the love of his life.',
    spanish:
      'Solo once días antes, recibió un "sí, por la eternidad" del amor de su vida.',
  },
  {
    norwegian:
...

  {
    ...
    spanish:
      "Puede llevar a enfermedades graves, según un nuevo estudio noruego.",
  },
  {
  ...
  {
    norwegian:
      "Opplever du kløe, svie og pustevansker etter samleie, kan du være rammet.",
    english:
      "If you experience itching, burning, and breathing difficulties after intercourse, you may be affected.",
    spanish:
  ...
  },
  {
    ...
    spanish:
      "¡Ahora el médico viene con una advertencia estricta: - Muy peligroso!",
  },
  {
    norwegian:
      "Ny melding etter dødsfallene til Diogo Jota (28​) og André Silva (25). ",
    english:
      "New message after the deaths of Diogo Jota (28) and André Silva (25).",
    spanish:
      "Nuevo mensaje tras las muertes de Diogo Jota (28) y André Silva (25).",
  },
  {
    norwegian:
      "Én av tre personer har ingen anelse om at de i det hele tatt har tilstanden, advarer lege.",
    english:
      "One in three people have no idea that they even have the condition, warns a doctor.",
    spanish:
      "Uno de cada tres personas no tiene idea de que siquiera tienen la condición, advierte un médico.",
  },
  {
    norwegian:
      "Da Nina (54) gikk tur på fjellet, fikk hun seg en stor overraskelse.",
    english:
      "When Nina (54) went for a walk in the mountains, she got a big surprise.",
    spanish:
      "Cuando Nina (54) salió a caminar por la montaña, se llevó una gran sorpresa.",
  },
  {
    ...
    spanish:
      "Los rumores están circulando sobre el hijo menor del presidente de EE.UU.",
  },
  {
    norwegian:
      "NRK-profilen i sitt siste intervju: - Altfor glad i livet til at jeg klarer å forsone meg med døden.",
    english:
      "NRK profile in her last interview: - Too fond of life to come to terms with death.",
    spanish:
      "Perfil de NRK en su última entrevista: - Demasiado aficionada a la vida como para aceptar la muerte.",
  },
  {
  ...
  {
    norwegian:
      "Det har kommet flere spekulasjoner og rykter om hvorfor Ronaldo ikke kom i begravelse.",
    english:
      "There have been several speculations and rumors about why Ronaldo did not attend the funeral.",
    spanish:
      "Ha habido varias especulaciones y rumores sobre por qué Ronaldo no asistió al funeral.",
  },
  {
    norwegian:
      "Trump får kraftig kritikk etter at han brukte et antisemittisk uttrykk under en tale.",
    english:
      "Trump receives strong criticism after using an anti-Semitic expression during a speech.",
    spanish:
      "Trump recibe fuertes críticas tras usar una expresión antisemita durante un discurso.",
  },
  {
    norwegian:
      "De tidligere ektefellene har punget ut millioner kroner hver for leiligheter som ligger vegg i vegg.",
    english:
      "The former spouses have each shelled out millions of kroner for apartments that are next to each other.",
    spanish:
  ...
  },
  {
    ...
    spanish:
      "Trude Drevland compartió una nueva actualización tras la fea caída.",
  },
  {
  ...
  },
  {
    ...
    english:
      "Burned bus: Three have been transported to the hospital with serious injuries.",
    spanish:
      "Autobús quemado: Tres han sido trasladados al hospital con heridas graves.",
  },
  {
    norwegian:
      "Astrid Smeplass (28​) får verden til å måpe: - Norge har sendt en «gudinne»",
    english:
      'Astrid Smeplass (28) makes the world gasp: - Norway has sent a "goddess"',
    spanish:
      'Astrid Smeplass (28) hace que el mundo se asombre: - Noruega ha enviado una "diosa"',
  },
  {
    ...
    spanish:
      "AHORA MISMO: Servicios de emergencia y helicóptero de rescate están en el lugar.",
  },
  {
    norwegian:
      "AKKURAT NÅ: Dødstallet stiger - bekrefter at flere er barn: - Hun er død",
    english:
      "RIGHT NOW: The death toll is rising - confirms that several are children: - She is dead",
    spanish:
      "AHORA MISMO: El número de muertos está aumentando - confirma que varios son niños: - Ella está muerta",
  },
  {
    norwegian:
      "Dette må du ikke finne på å gjøre på biltur, ifølge Trygg Trafikk.",
  ...
  {
    norwegian:
      "Dagbladets Spania-utsendte brant seg denne uka på en vanlig tabbe blant nordmenn.",
    english:
      "Dagbladet’s Spain correspondent burned himself this week on a common mistake among Norwegians.",
    spanish:
      "El corresponsal de Dagbladet en España se quemó esta semana con un error común entre los noruegos.",
  },
  {
  ...
  {
    norwegian:
      "Carita Strøm brukt utallige timer på å pusse opp familiens campingvogn. Så rammet marerittet.",
    english:
      "Carita Strøm spent countless hours renovating the family’s caravan. Then the nightmare struck.",
    spanish:
      "Carita Strøm pasó incontables horas renovando la caravana de la familia. Entonces llegó la pesadilla.",
  },
  {
  ...
  {
    norwegian:
      "Her får du denne ukas viktigste nyheter oppsummert av Dagbladet Pluss- og printredaktør Bjørn Carlsen.",
    english:
  ...
  {
    norwegian:
      "Etter ni år som kjærester fikk nok være nok, tenkte OL-sølvvinner Mons Røisland (28​).",
    english:
      "After nine years as a couple, enough was enough, thought Olympic silver medalist Mons Røisland (28).",
    spanish:
      "Después de nueve años como pareja, fue suficiente, pensó el medallista de plata olímpico Mons Røisland (28).",
  },
  {
    norwegian:
      "Politiet bekrefter fredag at en norsk, kjent treningsprofil er død.",
    english:
      "The police confirm on Friday that a Norwegian, well-known training profile has died.",
    spanish:
      "La policía confirma el viernes que un perfil de entrenamiento noruego conocido ha fallecido.",
  },
  {
  ...
  {
    norwegian:
      "Scott Engh (22) - for mange kjent som «Coach Engh» - har gått bort i en ulykke.",
    english:
      'Scott Engh (22) - known to many as "Coach Engh" - has passed away in an accident.',
    spanish:
      'Scott Engh (22) - conocido por muchos como "Coach Engh" - ha fallecido en un accidente.',
  },
  {
  ...
  },
  {
    ...
    english:
      "The man from Modum was enjoying a cup of tea in the garden. Suddenly, there was a bang.",
    spanish:
      "El hombre de Modum estaba disfrutando de una taza de té en el jardín. De repente, hubo un estruendo.",
  },
  {
    norwegian:
      "Tina Bru (H) har lagt merke til at Frp vil ha kunnskapsministeren etter valget.",
    english:
      "Tina Bru (H) has noticed that the Progress Party wants the Minister of Knowledge after the election.",
    spanish:
  ...
  },
  {
    ...
    english:
      "This is what the Norwegian stars are doing in the lead-up to the new season.",
    spanish:
      "Esto es lo que las estrellas noruegas están haciendo en la preparación para la nueva temporada.",
  },
  {
  ...
  {
    norwegian:
      "Norges mest kjente tag forsvant søndag kveld, men mandag har den gjenoppstått.",
    english:
      "Norway’s most famous tag disappeared on Sunday evening, but on Monday it has reappeared.",
    spanish:
      "La etiqueta más famosa de Noruega desapareció el domingo por la noche, pero el lunes ha resurgido.",
  },
  {
    norwegian:
      "Australske Erin Patterson (50) nektet for å ha drept tre familiemedlemmer med giftig sopp.",
    english:
      "Australian Erin Patterson (50) denied killing three family members with poisonous mushrooms.",
    spanish:
      "La australiana Erin Patterson (50) negó haber matado a tres miembros de su familia con setas venenosas.",
  },
  {
  ...
  {
    norwegian:
      "Jeg vil også kjenne på frihet – men rullestolen min gjør det umulig.",
    english:
      "I also want to feel freedom – but my wheelchair makes it impossible.",
    spanish:
      "También quiero sentir libertad, pero mi silla de ruedas lo hace imposible.",
  },
  {
  ...
  {
    norwegian:
      "Det er på høy tid noen sier det rett ut: Værvarslingstjenestene Yr og Storm er blitt en forbannelse.",
    english:
  ...
  {
    norwegian:
      "Dødstallet etter flommen i Texas stiger. Minst 82 er bekreftet omkommet, inkludert 28 barn.",
    english:
      "The death toll from the flood in Texas is rising. At least 82 are confirmed dead, including 28 children.",
    spanish:
  ...
  {
    norwegian:
      "Aktivister går nakne gjennom byen i protest mot okseløpene i Pamplona, Spania.",
    english:
      "Activists walk naked through the city in protest against the bull runs in Pamplona, Spain.",
    spanish:
      "Activistas caminan desnudos por la ciudad en protesta contra las corridas de toros en Pamplona, España.",
  },
  {
    norwegian:
      "Medfangene hyllet musikkmogulen da han kom tilbake til soning, ifølge advokaten.",
    english:
      "Fellow inmates hailed the music mogul when he returned to prison, according to his lawyer.",
    spanish:
      "Los compañeros de prisión vitorearon al magnate de la música cuando regresó a la cárcel, según su abogado.",
  },
  {
    norwegian:
      "Nå liker til og med unge kvinner Sylvi Listhaug, skriver VGs kommentator.",
    english:
      "Now even young women like Sylvi Listhaug, writes VG’s commentator.",
    spanish:
      "Ahora incluso las mujeres jóvenes gustan de Sylvi Listhaug, escribe el comentarista de VG.",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "Salir con un demócrata está fuera de cuestión en este barco de fiesta.",
  },
  {
    norwegian:
      "Bakerst i bussen skal tenåringsgutten ha fiklet med noe. Brått så tok det fyr.",
    english:
  ...
  {
    norwegian:
      "Mens andre flyktet i panikk, handlet Bernt Sveen (65) raskt for å redde busspassasjerer.",
    english:
      "While others fled in panic, Bernt Sveen (65) acted quickly to save bus passengers.",
    spanish:
  ...
  {
    norwegian:
      "MENINGER: Som gravid er det provoserende å lese om at vi bør komme oss tilbake på jobb.",
    english:
      "OPINION: As a pregnant woman, it is infuriating to read that we should hurry back to work.",
    spanish:
      "OPINIÓN: Como mujer embarazada, es irritante leer que deberíamos volver al trabajo rápidamente.",
  },
  {
    norwegian:
  ...
  },
  {
    ...
    english:
      "This is stated by the police operations leader Atle Vesttorp to VG.",
    spanish:
      "Así lo afirma el jefe de operaciones policiales Atle Vesttorp a VG.",
  },
  {
    norwegian:
  ...
  },
  {
    ...
    english:
      "The thieves found exactly what they were looking for in the Løren block.",
    spanish:
      "Los ladrones encontraron exactamente lo que buscaban en el bloque de Løren.",
  },
  {
    norwegian:
      "De opplevde seg isolert. Nå har de tatt over lokalene fra legendarisk restaurant.",
    english:
      "They felt isolated. Now they have taken over the premises from a legendary restaurant.",
    spanish:
      "Se sentían aislados. Ahora han tomado las instalaciones de un restaurante legendario.",
  },
  {
  ...
  {
    norwegian:
      "Mens bussjåføren skrek ut av vinduet, pekte fotgjengeren på den lysende, grønne mannen.",
    english:
      "While the bus driver was shouting out the window, the pedestrian pointed at the glowing green man.",
    spanish:
      "Mientras el conductor del autobús gritaba por la ventana, el peatón señalaba al hombre verde brillante.",
  },
  {
    norwegian:
      "En kvinne og en mann er tiltalt for grovt ran og grov vold mot to kvinner.",
    english:
      "A woman and a man have been charged with aggravated robbery and aggravated violence against two women.",
    spanish:
      "Una mujer y un hombre han sido acusados de robo agravado y violencia agravada contra dos mujeres.",
  },
  {
    norwegian:
      "Første dag av fellesferien byr på regn og temperaturer under 20 grader. Så snur det.",
    english:
      "The first day of the joint holiday offers rain and temperatures below 20 degrees. Then it turns around.",
    spanish:
  ...
  {
    norwegian:
      "Regnestykket deres gir ingen mening, mener FAU-leder Kristel Berre.",
    english: "Their calculations make no sense, says FAU leader Kristel Berre.",
    spanish:
      "Sus cálculos no tienen sentido, dice la presidenta de FAU, Kristel Berre.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Vi sier tydelig nei til å svekke kravene til brannsikkerhet, skriver Britt Fossum.",
    english:
      "We clearly say no to weakening fire safety requirements, writes Britt Fossum.",
    spanish:
      "Decimos claramente no a debilitar los requisitos de seguridad contra incendios, escribe Britt Fossum.",
  },
  {
    norwegian:
      "Ruters endringer skaper hodebry for Aleksandra og familien. Saken er åpen for alle.",
    english:
      "Ruter’s changes create headaches for Aleksandra and her family. The case is open to everyone.",
    spanish:
      "Los cambios de Ruter crean dolores de cabeza para Aleksandra y su familia. El caso está abierto a todos.",
  },
  {
    norwegian: "Satt bak rattet da han varslet sykehuset. Det ble dyrt.",
    english:
      "Sat behind the wheel when he notified the hospital. It was expensive.",
    spanish:
      "Se sentó detrás del volante cuando notificó al hospital. Fue caro.",
  },
  {
    norwegian:
      "Taggen har blitt fjernet flere ganger siden 80-tallet. Den har derimot blitt vekket tilbake til liv hver eneste gang.",
    english:
      "The tag has been removed several times since the 1980s. However, it has been revived every single time.",
    spanish:
      "La etiqueta ha sido eliminada varias veces desde la década de 1980. Sin embargo, ha sido revivida cada vez.",
  },
  {
    norwegian:
      "Ordet «Sædfuck» har prydet undergangen på Bøler i nesten 40 år. Nå er den forsvunnet.",
    english:
      'The word "Sædfuck" has adorned the underpass at Bøler for almost 40 years. Now it is gone.',
    spanish:
  ...
  {
    norwegian:
      "I årevis har flere av beboerne på Ulvøya ønsket seg et forbud mot fiskingen.",
    english:
      "For years, several residents of Ulvøya have wanted a ban on fishing.",
    spanish:
      "Durante años, varios residentes de Ulvøya han deseado una prohibición de la pesca.",
  },
  {
  ...
  {
    norwegian:
      "Eieren er en omstridt milliardær. Den forlatte luksusvillaen skjuler en dramatisk historie.",
    english:
      "The owner is a controversial billionaire. The abandoned luxury villa hides a dramatic story.",
    spanish:
  ...
  },
  {
    ...
    english:
      "Everyone who was convicted by the politician had to be acquitted.",
    spanish:
      "Todos los que fueron condenados por el político debían ser absueltos.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Det er ikke anbefalt, men du får ikke rettelse hvis du skriver det. Hva kaller du strøket for?",
    english:
      "It is not recommended, but you will not get a correction if you write it. What do you call the strikeout?",
    spanish:
      "No está recomendado, pero no recibirás una corrección si lo escribes. ¿Cómo llamas al tachado?",
  },
  {
    norwegian:
      "De eier fortsatt restauranten sammen, men nå er det full strid.",
    english:
      "They still own the restaurant together, but now there is full conflict.",
    spanish:
      "Todavía son dueños del restaurante juntos, pero ahora hay un conflicto total.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Sofie og Inger går i Lappemannens fotspor. Flere ganger har de vært nær å avsløre personen bak.",
    english:
  ...
  {
    norwegian:
      "En årelang strid ligger bak det kjente navnet. Men hva sier folket? Og hva er korrekt?",
    english:
      "A long-standing dispute lies behind the well-known name. But what does the public say? And what is correct?",
    spanish:
      "Una disputa de larga data está detrás del nombre conocido. ¿Pero qué dice la gente? ¿Y cuál es correcto?",
  },
  {
    norwegian: "En mann er kjørt til sykehus. Politiet etterlyser vitner.",
    english:
      "A man has been taken to the hospital. The police are asking for witnesses.",
  ...
  },
  {
    ...
    spanish:
      "El sospechoso huyó del lugar. Enlace al caso en la sección de comentarios.",
  },
  {
    norwegian:
      "Mange har fått med seg at det har skjedd endringer i lokalet den siste tida, sier Løkka-baren.",
    english:
      "Many have noticed that there have been changes in the premises recently, says the Løkka bar.",
    spanish:
      "Muchos han notado que ha habido cambios en el local recientemente, dice el bar de Løkka.",
  },
  {
    norwegian:
      "Flere ble møtt av en overraskelse på T-banestasjonen denne helgen.",
    english:
      "Several were met with a surprise at the subway station this weekend.",
    spanish:
      "Varios se encontraron con una sorpresa en la estación de metro este fin de semana.",
  },
  {
    norwegian:
  ...
  },
  {
    ...
    english:
      "One and a half years without an answer – now Samfundet complains to the Civil Ombudsman",
    spanish:
      "Un año y medio sin respuesta – ahora Samfundet se queja al Defensor Civil",
  },
  {
    norwegian:
      "Nils-Petter Enstad, tidligere abonnent, tar et oppgjør med Dagens betalingsmur",
    english:
      "Nils-Petter Enstad, former subscriber, takes a stand against Dagens paywall",
    spanish:
      "Nils-Petter Enstad, ex suscriptor, se enfrenta al muro de pago de Dagens",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Hva ønsker Dagen egentlig å formidle i sin sak om Lundeneset videregående skole?",
    english:
      "What does Dagen actually want to convey in its case about Lundeneset Upper Secondary School?",
    spanish:
      "¿Qué quiere transmitir Dagen realmente en su caso sobre la Escuela Secundaria Superior Lundeneset?",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Det store spørsmålet nå er hvordan USA vil reagere på angrepet.",
    english: "The big question now is how the USA will react to the attack.",
    spanish:
      "La gran pregunta ahora es cómo reaccionará Estados Unidos al ataque.",
  },
  {
    norwegian:
      "Mye står på spill når Misjonssambandet denne uken samles til generalforsamling.",
    english:
      "A lot is at stake when the Mission Alliance gathers for a general assembly this week.",
    spanish:
      "Mucho está en juego cuando la Alianza Misionera se reúne para una asamblea general esta semana.",
  },
  {
    norwegian:
      "Onsdag tok de farvel med mormoren. Lørdag sto de på scenen på Risøya.",
    english:
      "On Wednesday they said goodbye to their grandmother. On Saturday they were on stage at Risøya.",
    spanish:
      "El miércoles se despidieron de su abuela. El sábado estaban en el escenario en Risøya.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Politiet i Melbourne bekrefter at brannstiftelsen var antisemittisk motivert.",
    english:
      "The police in Melbourne confirm that the arson was anti-Semitically motivated.",
    spanish:
      "La policía de Melbourne confirma que el incendio provocado fue motivado por el antisemitismo.",
  },
  {
    norwegian:
      "Å lytte til Guds stemme er en sentral praksis på IMI-kirkens sommerfestival.",
    english:
      "Listening to God’s voice is a central practice at IMI Church’s summer festival.",
    spanish:
      "Escuchar la voz de Dios es una práctica central en el festival de verano de la iglesia IMI.",
  },
  {
    norwegian:
      "De kristne filmskaperne nekter for at de har laget en «kristen» film.",
    english:
      'The Christian filmmakers deny that they have made a "Christian" film.',
    spanish:
      'Los cineastas cristianos niegan haber hecho una película "cristiana".',
  },
  {
    norwegian:
      "Ein tankekross for dei som rosar Donald Trump for innsatsen for trusfridom, skriv Johannes Morken.",
    english:
      "A blow to those who praise Donald Trump for his efforts for freedom of religion, writes Johannes Morken.",
    spanish:
      "Un golpe para aquellos que alaban a Donald Trump por sus esfuerzos por la libertad de religión, escribe Johannes Morken.",
  },
  {
    norwegian:
      "Fortel ope at ho meiner kristne verdiar legg det beste grunnlaget for eit velfungerande samfunn.",
    english:
      "Openly state that she believes Christian values lay the best foundation for a well-functioning society.",
    spanish:
  ...
  {
    norwegian:
      "Nå får han en delvis oppreisning fra organisasjonen han tidligere ledet.",
    english:
      "Now he is getting partial redress from the organization he previously led.",
    spanish:
      "Ahora está recibiendo una compensación parcial de la organización que dirigió anteriormente.",
  },
  {
    norwegian:
      "Flere parter presser på for at Hamas skal takke ja til våpenhvileforslaget.",
    english:
      "Several parties are pushing for Hamas to accept the ceasefire proposal.",
    spanish:
      "Varias partes están presionando para que Hamas acepte la propuesta de alto el fuego.",
  },
  {
    norwegian:
      "Gud har sendt oss viralt for å trekke flere unge mennesker til kirken.",
    english:
      "God has sent us viral to attract more young people to the church.",
    spanish:
      "Dios nos ha enviado viral para atraer a más jóvenes a la iglesia.",
  },
  {
  ...
  {
    norwegian:
      "«Det virker tidvis som om Høyre har splittet personlighet», skriver Asle Toje.",
    english:
      '"It sometimes seems as if the Right has a split personality," writes Asle Toje.',
    spanish:
      '"A veces parece que la Derecha tiene una personalidad dividida", escribe Asle Toje.',
  },
  {
    norwegian:
      "Stortingskandidaten utfordrer partiledelsen i spørsmål om pride.",
    english:
      "The parliamentary candidate challenges the party leadership on questions about pride.",
    spanish:
      "El candidato parlamentario desafía al liderazgo del partido en cuestiones sobre el orgullo.",
  },
  {
    norwegian:
      "Stiftelsen hans hjelper foreldreløse og gatebarn gjennom lokalt engasjement i Kenya.",
    english:
      "His foundation helps orphans and street children through local engagement in Kenya.",
    spanish:
      "Su fundación ayuda a huérfanos y niños de la calle a través del compromiso local en Kenia.",
  },
  {
    norwegian:
  ...
  {
    norwegian:
      "Kristne musikkartistar i USA er i «tastaturkrig» etter at skuldingane mot Michael Tait kom fram.",
    english:
  ...
  {
    norwegian:
      "Sektlederen Sergej Torop, som hevdet han var Jesus gjenoppstått, havner nå bak lås og slå i Russland.",
    english:
      "Sect leader Sergei Torop, who claimed to be the resurrected Jesus , is now behind bars in Russia.",
    spanish:
  ...
  {
    norwegian:
      "MINNEORD: «Lavmælt, lyttende og fredsskapende med en lun humor».",
    english: 'OBITUARY: "Quiet, listening and peace-making with a warm humor."',
    spanish:
      'OBITUARIO: "Tranquilo, escuchador y pacificador con un humor cálido".',
  },
  {
  ...
  {
    norwegian:
      "jeg skal jobbe med tabellen, fanene og modalen på den ene siden",
  ...
  },
  {
    ...
    spanish:
      "Es tan agradable vivir aunque las patas de la silla estén torcidas",
  },
  {
    english: "I set the table with candles and red roses",
    norwegian: "Jeg dekker på med lys og røde roser",
  ...
  {
    english:
      "it looks like (description, e.g. an old building, a busy street, etc.)",
    norwegian:
      "det ser ut som (beskrivelse, f.eks. en gammel bygning, en travel gate osv.)",
    spanish:
      "parece (descripción, por ejemplo, un edificio antiguo, una calle concurrida, etc.)",
  },
  {
    english:
      "it seems like (situation, e.g. a quiet park, a busy market, etc.)",
    norwegian:
      "det virker som (situasjon, f.eks. en rolig park, et travelt marked osv.)",
    spanish:
      "parece (situación, por ejemplo, un parque tranquilo, un mercado concurrido, etc.)",
  },
  {
  ...
  },
  {
    ...
    norwegian:
      "det ligger i nærheten av (et landemerke, en elv, et fjell osv.)",
  ...
  },
  {
    ...
    spanish:
      "está en medio de (una ciudad, un bosque, una llanura abierta, etc.)",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "la zona es conocida por (sitios históricos, belleza natural, etc.)",
  },
  {
    ...
    spanish:
      "puedes encontrar (tiendas, personas, animales, etc.) aquí en la zona",
  },
  {
  ...
  },
  {
    ...
    spanish:
      "gire a la izquierda/derecha en (punto de referencia/nombre de la calle)",
  },
  {
    english:
      "pass by (a specific place), and you will find it on the left/right side",
    norwegian:
      "gå/kjør forbi (et spesifikt sted), og du finner det på venstre/høyre side",
    spanish:
      "pasa por (un lugar específico), y lo encontrarás a la izquierda/derecha",
  },
  {
  ...
  },
  {
    ...
    norwegian:
      "vitenskap, matematikk, språk og nyheter er alle former for utdanning",
    spanish:
      "la ciencia, las matemáticas, el lenguaje y las noticias son todas formas de educación",
  },
  {
